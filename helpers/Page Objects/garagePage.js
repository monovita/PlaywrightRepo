...
export class GaragePage extends BasePage {
    ...
    get addCarButton() {
        return this._page.locator(`[class="btn btn-primary"]`).filter({ hasText: 'Add car' });//getByText('Add car');
    }
    ...
    get addButton() {
        return this._page.locator(`[type="button"]`).filter({ hasText: 'Add' })//getByText('Add'); 
    }
